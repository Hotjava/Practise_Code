...
namespace ASPPatterns.Chap3.Layered.WebUI
{
    public partial class Default : System.Web.UI.Page,IProductListView
    {
        ...
        public void Dispaly(IList<ProductViewModel> products)
        {
        ...
        public string ErrorMessage { set { lblErrorMessage.Text = string.Format("<p><strong>Error</strong><br/>{0}</p>", value); } }
    }
}